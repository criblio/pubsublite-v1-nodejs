...
import * as publisherserviceModule from '../src';
...
describe('v1.PublisherServiceClient', () => {
    it('has servicePath', () => {
        const servicePath = publisherserviceModule.v1.PublisherServiceClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = publisherserviceModule.v1.PublisherServiceClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = publisherserviceModule.v1.PublisherServiceClient.port;
        assert(port);
    ...
    it('has initialize method and supports deferred initialization', async () => {
        ...
        assert.strictEqual(client.publisherServiceStub, undefined);
        await client.initialize();
        assert(client.publisherServiceStub);
    });
    ...
    describe('publish', () => {
        it('invokes publish without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.pubsublite.v1.PublishRequest());
            const expectedResponse = generateSampleMessage(new protos.google.cloud.pubsublite.v1.PublishResponse());
            client.innerApiCalls.publish = stubBidiStreamingCall(expectedResponse);
            const stream = client.publish();
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.cloud.pubsublite.v1.PublishResponse) => {
                    resolve(response);
                });
        ...
        it('invokes publish with error', async () => {
            ...
            client.innerApiCalls.publish = stubBidiStreamingCall(undefined, expectedError);
            const stream = client.publish();
            const promise = new Promise((resolve, reject) => {
                stream.on('data', (response: protos.google.cloud.pubsublite.v1.PublishResponse) => {
                    resolve(response);
